...
class OnBoarding_SecondScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.onboarding_fragment_second_screen, container, false)

        val viewPager = activity?.findViewById<ViewPager2>(R.id.onBoardingViewPagerID)
        val onBoardingNextButton = view.findViewById<Button>(R.id.OnBoardingNextButtonID2)
        val onBoardingBackButton = view.findViewById<Button>(R.id.OnBoardingBackButtonID2)
        val onBoardingSkipButton = view.findViewById<Button>(R.id.OnBoardingSkipButtonID2)
